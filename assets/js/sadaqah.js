...
export function renderSadaqahPage(container) {
  ...
  const COPY = {
    ...
    pageDesc:     { fa:'ارسال وجه به پلتفرم برکت‌هاب کربلا', ar:'إرسال مبلغ إلى منصة ميدياهاب كربلاء', ur:'برکت‌ہب کربلا کو رقم بھیجیں', az:'BarakatHub Kərbəlaya ödəniş göndər', tr:'BarakatHub Kerbela platformuna ödeme gönder', ru:'Отправить платёж на платформу BarakatHub Кербела', en:'Send payment to BarakatHub Karbala platform', id:'Kirim pembayaran ke platform BarakatHub Karbala' },
