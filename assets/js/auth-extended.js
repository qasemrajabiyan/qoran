...
export const COUNTRIES = [
  ...
  { code:'AE', name:{ fa:'امارات متحده عربی',ar:'الإمارات العربية المتحدة',ur:'متحدہ عرب امارات',en:'UAE',tr:'BAE',ru:'ОАЭ',az:'BƏƏ',id:'UEA' }, flag:'🇦🇪', lang:'ar' },
  ...
  { code:'AD', name:{ fa:'آندورا',ar:'أندورا',ur:'اندورا',en:'Andorra',tr:'Andorra',ru:'Андорра',az:'Andorra',id:'Andorra' }, flag:'🇦🇩', lang:'ca' },
  ...
  { code:'BJ', name:{ fa:'بنین',ar:'بنين',ur:'بنین',en:'Benin',tr:'Benin',ru:'Бенин',az:'Benin',id:'Benin' }, flag:'🇧🇯', lang:'fr' },
  { code:'BO', name:{ fa:'بولیوی',ar:'بوليفيا',ur:'بولیویا',en:'Bolivia',tr:'Bolivya',ru:'Боливия',az:'Boliviya',id:'Bolivia' }, flag:'🇧🇴', lang:'es' },
  { code:'BA', name:{ fa:'بوسنی',ar:'البوسنة والهرسك',ur:'بوسنیا',en:'Bosnia',tr:'Bosna Hersek',ru:'Босния',az:'Bosniya',id:'Bosnia' }, flag:'🇧🇦', lang:'bs' },
  ...
  { code:'CL', name:{ fa:'شیلی',ar:'تشيلي',ur:'چلی',en:'Chile',tr:'Şili',ru:'Чили',az:'Çili',id:'Chili' }, flag:'🇨🇱', lang:'es' },
  ...
  { code:'CD', name:{ fa:'کنگو',ar:'الكونغو الديمقراطية',ur:'کانگو',en:'DR Congo',tr:'DR Kongo',ru:'ДР Конго',az:'DR Konqo',id:'Kongo' }, flag:'🇨🇩', lang:'fr' },
  ...
  { code:'DO', name:{ fa:'دومینیکن',ar:'جمهورية الدومينيكان',ur:'ڈومینیکن',en:'Dominican Rep.',tr:'Dominik',ru:'Доминиканa',az:'Dominikan',id:'Dominika' }, flag:'🇩🇴', lang:'es' },
  { code:'EC', name:{ fa:'اکوادور',ar:'الإكوادور',ur:'ایکواڈور',en:'Ecuador',tr:'Ekvador',ru:'Эквадор',az:'Ekvador',id:'Ekuador' }, flag:'🇪🇨', lang:'es' },
  { code:'SV', name:{ fa:'السالوادور',ar:'السلفادور',ur:'ایل سیلواڈور',en:'El Salvador',tr:'El Salvador',ru:'Сальвадор',az:'Salvador',id:'El Salvador' }, flag:'🇸🇻', lang:'es' },
  ...
  { code:'GT', name:{ fa:'گواتمالا',ar:'غواتيمالا',ur:'گواٹیمالا',en:'Guatemala',tr:'Guatemala',ru:'Гватемала',az:'Qvatemala',id:'Guatemala' }, flag:'🇬🇹', lang:'es' },
  { code:'HN', name:{ fa:'هندوراس',ar:'هندوراس',ur:'ہونڈراس',en:'Honduras',tr:'Honduras',ru:'Гондурас',az:'Honduras',id:'Honduras' }, flag:'🇭🇳', lang:'es' },
  { code:'HK', name:{ fa:'هنگ‌کنگ',ar:'هونج كونج',ur:'ہانگ کانگ',en:'Hong Kong',tr:'Hong Kong',ru:'Гонконг',az:'Honq Konq',id:'Hong Kong' }, flag:'🇭🇰', lang:'zh' },
  ...
  { code:'LU', name:{ fa:'لوکزامبورگ',ar:'لوكسمبورغ',ur:'لکسمبرگ',en:'Luxembourg',tr:'Lüksemburg',ru:'Люксембург',az:'Lüksemburq',id:'Luksemburg' }, flag:'🇱🇺', lang:'lu' },
  { code:'MY', name:{ fa:'مالزی',ar:'ماليزيا',ur:'ملائیشیا',en:'Malaysia',tr:'Malezya',ru:'Малайзия',az:'Malayziya',id:'Malaysia' }, flag:'🇲🇾', lang:'ms' },
  { code:'MV', name:{ fa:'مالدیو',ar:'المالديف',ur:'مالدیپ',en:'Maldives',tr:'Maldivler',ru:'Мальдивы',az:'Maldiv',id:'Maladewa' }, flag:'🇲🇻', lang:'dv' },
  ...
  { code:'MR', name:{ fa:'موریتانی',ar:'موريتانيا',ur:'موریتانیا',en:'Mauritania',tr:'Moritanya',ru:'Мавритания',az:'Mavritaniya',id:'Mauritania' }, flag:'🇲🇷', lang:'ar' },
  { code:'MX', name:{ fa:'مکزیک',ar:'المكسيك',ur:'میکسیکو',en:'Mexico',tr:'Meksika',ru:'Мексика',az:'Meksika',id:'Meksiko' }, flag:'🇲🇽', lang:'es' },
  { code:'MD', name:{ fa:'مولداوی',ar:'مولدوفا',ur:'مالڈووا',en:'Moldova',tr:'Moldova',ru:'Молдова',az:'Moldova',id:'Moldova' }, flag:'🇲🇩', lang:'ro' },
  ...
  { code:'SK', name:{ fa:'اسلواکی',ar:'سلوفاكيا',ur:'سلوواکیا',en:'Slovakia',tr:'Slovakya',ru:'Словакия',az:'Slovakiya',id:'Slovakia' }, flag:'🇸🇰', lang:'sk' },
  ...
  { code:'UY', name:{ fa:'اروگوئه',ar:'أوروغواي',ur:'یوروگوائے',en:'Uruguay',tr:'Uruguay',ru:'Уругвай',az:'Uruqvay',id:'Uruguay' }, flag:'🇺🇾', lang:'es' },
