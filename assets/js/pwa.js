...
export class PWA {
  ...
  _t(key) {
    const map = {
      'pwa.installTitle':   { fa: 'برکت‌هاب را نصب کنید', ar: 'ثبّت تطبيق مدياهاب', ur: 'برکت‌ہب انسٹال کریں', az: 'BarakatHub-u quraşdırın', tr: 'BarakatHub\'u Yükle', ru: 'Установить BarakatHub', en: 'Install BarakatHub' },
